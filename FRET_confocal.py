...
path_root=r"/Users/Mathew/Documents/Edinburgh Code/FRET_TCCD_Analysis/20220228_Mouse_CSF/"

# # # Foldert to analyse here:
pathlist.append(r"/Users/Mathew/Documents/Edinburgh Code/FRET_TCCD_Analysis/20220228_Mouse_CSF/0_5uM-1h/")
pathlist.append(r"/Users/Mathew/Documents/Edinburgh Code/FRET_TCCD_Analysis/20220228_Mouse_CSF/0_5um_1w/")
...
channelB_thresh=5 # Threshold for Channel B (Red).
...
for path in pathlist:
    ...
    y_bins = np.linspace(0,20,50)
    plt.hist2d(FRET_events, sizes, bins=[x_bins,y_bins],cmap='rainbow')
    # plt.colors.LogNorm()
    plt.colorbar()
